...
# Mountain Car Continuous ortamını başlatıyoruz ve render_mode parametresini belirtiyoruz
...
total_timesteps = 100000  # Bu değeri daha uzun eğitimler için arttırabilirsiniz
...
for _ in range(5):  # Örnek olarak 5 eğitimi döngüye aldık, daha fazla artırabilirsiniz
    ...
    for _ in range(200):
        ...
        obs, reward, done, truncated, info = env.step(action)  # Beş değer alıyoruz
        episode_rewards.append(reward)
        env.render()  # Her adımda ortamı görselleştiriyoruz
